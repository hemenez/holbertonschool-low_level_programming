...
The standard library provides a similar function (`memcpy`)
...
The standard library provides a similar function (`strspn`)
...
The standard library provides a similar function (`strstr`)
